    ...
    <div class="Productpage">
        ...
        <div class="product">
            ...
            <div class="productdet">
                <!-- <Show style="background-color:rgba(59, 183, 126, 0.20);height:min-content;width: max-content;padding-right: 2rem;color:var(--tpgreen);border-radius: 5px;" fww="600" title="In Stock"/> -->
                ...
                <div style="display:flex; gap:0.5rem; align-items:center;">
                    ...
                    <!-- <span>(<p3>{{ Number(Product.Rate).toFixed(1) }}</p3>)</span> -->
                </div>
